							...
							<form action="{{ route('register') }}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" name="name" id="name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Your name here" :value="old('name')" required autofocus autocomplete="name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" :value="old('email')" required>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
